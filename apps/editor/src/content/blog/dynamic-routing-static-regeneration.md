...
<Callout>
  <span>The text below is from the</span>
  <a href="https://play.tailwindcss.com/uj1vGACRJA?layout=preview">Tailwind CSS</a>
  <span>docs. I copied it here to test the markdown styles.</span>
  <strong>Tailwind is awesome. You should use it.</strong>
</Callout>
