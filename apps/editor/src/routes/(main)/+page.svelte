...
<div class="w-full my-8">
  ...
  <div class="hero py-32">
    <div class="hero-content">
      <div class="max-w-5xl space-y-4 text-center">
        ...
        <p class="max-w-3xl mx-auto leading-normal sm:text-xl sm:leading-8">
          I&apos;m building a web app with Next.js 13 and open sourcing everything. Follow along as
          we figure this out together.
        </p>

        <div class="space-x-4">
          <a href="/" class="btn btn-primary lg:btn-wide">Get Started</a>
          <a href="/" class="btn btn-outline lg:btn-wide">GitHub</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- Features -->
  <section id="features" class="container p-16 mx-auto space-y-6 bg-base-200 dark:bg-inherit">
  ...
  <!-- Open Source -->
  <section id="open-source" class="container mx-auto py-8 md:py-12 lg:py-24">
    <div class="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
      ...
      <p class="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
        ...
        <a href="/" target="_blank" rel="noreferrer" class="underline underline-offset-4">
          GitHub
        </a>
        <span>.</span>
      </p>
      {#if stars}
        <a href="/" target="_blank" rel="noreferrer" class="flex">
          <div
            class="flex h-10 w-10 items-center justify-center space-x-2 rounded-md border border-muted bg-muted"
          >
            <svg
          ...
          <div class="flex items-center">
            <div
              class="h-4 w-4 border-y-8 border-l-0 border-r-8 border-solid border-muted border-y-transparent"
            />
            <div
              class="flex h-10 items-center rounded-md border border-muted bg-muted px-4 font-medium"
            >
